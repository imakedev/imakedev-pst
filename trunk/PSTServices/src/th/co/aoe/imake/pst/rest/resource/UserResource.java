...
import th.co.aoe.imake.pst.managers.UserService;
...
public class UserResource  extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.aoe.imake.pst.xstream.User.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.aoe.imake.pst.xstream.User xbpsTerm = new th.co.aoe.imake.pst.xstream.User();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.aoe.imake.pst.xstream.User) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						th.co.aoe.imake.pst.hibernate.bean.User bpsTerm = new th.co.aoe.imake.pst.hibernate.bean.User();
						...
						if(serviceName.equals(ServiceConstant.USER_FIND_BY_ID)){
							...
							if(obj!=null){
								th.co.aoe.imake.pst.hibernate.bean.User user = (th.co.aoe.imake.pst.hibernate.bean.User)obj;
								BeanUtils.copyProperties(user, xbpsTerm) ;
							}
						//logger.debug(" object return ="+ntcCalendarReturn);
						VResultMessage vresultMessage = new VResultMessage();
							if(xbpsTerm!=null){
								List<th.co.aoe.imake.pst.xstream.User> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.User>(1);
							...
							if (result != null && result.size() == 2) {
								...
								java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.User> ntcCalendars = (java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.User>) result
										.get(0);
								String faqs_size = (String) result.get(1);
								VResultMessage vresultMessage = new VResultMessage();
								List<th.co.aoe.imake.pst.xstream.User> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.User>();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.aoe.imake.pst.xstream.User xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.aoe.imake.pst.xstream.User> xbpsTerms = new ArrayList<th.co.aoe.imake.pst.xstream.User>(1);
	...
	private List<th.co.aoe.imake.pst.xstream.User> getxUserObject(
			java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.User> ntcCalendars) {
		List<th.co.aoe.imake.pst.xstream.User> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.User>(
				ntcCalendars.size());
		for (th.co.aoe.imake.pst.hibernate.bean.User missManual : ntcCalendars) {
			th.co.aoe.imake.pst.xstream.User xmissManual =new th.co.aoe.imake.pst.xstream.User ();
