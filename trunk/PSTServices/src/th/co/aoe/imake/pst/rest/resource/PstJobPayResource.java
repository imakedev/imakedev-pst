...
import th.co.aoe.imake.pst.managers.PstJobPayService;
...
public class PstJobPayResource  extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.aoe.imake.pst.xstream.PstJobPay.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.aoe.imake.pst.xstream.PstJobPay xbpsTerm = new th.co.aoe.imake.pst.xstream.PstJobPay();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.aoe.imake.pst.xstream.PstJobPay) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						th.co.aoe.imake.pst.hibernate.bean.PstJobPay bpsTerm = new th.co.aoe.imake.pst.hibernate.bean.PstJobPay();
						BeanUtils.copyProperties(xbpsTerm,bpsTerm,ignore_id); 
						
						th.co.aoe.imake.pst.hibernate.bean.PstJobPayPK pk =new th.co.aoe.imake.pst.hibernate.bean.PstJobPayPK();
						...
						if(serviceName.equals(ServiceConstant.PST_JOB_PAY_SAVE)){
							...
							th.co.aoe.imake.pst.hibernate.bean.PstJobPayPK  returnId=null;
							returnId=(th.co.aoe.imake.pst.hibernate.bean.PstJobPayPK) (pstCommonService.save(bpsTerm));
							...
							List result = (List) pstJobPayService.listPstJobPays(xbpsTerm.getPjId(), xbpsTerm.getPcId());
								...
								java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstJobPay> ntcCalendars = (java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstJobPay>) result;
										 
								VResultMessage vresultMessage = new VResultMessage();
								List<th.co.aoe.imake.pst.xstream.PstJobPay> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.PstJobPay>();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.aoe.imake.pst.xstream.PstJobPay xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.aoe.imake.pst.xstream.PstJobPay> xbpsTerms = new ArrayList<th.co.aoe.imake.pst.xstream.PstJobPay>(1);
	...
	private List<th.co.aoe.imake.pst.xstream.PstJobPay> getxPstJobPayObject(
			java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstJobPay> ntcCalendars) {
		List<th.co.aoe.imake.pst.xstream.PstJobPay> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.PstJobPay>(
				ntcCalendars.size());
		for (th.co.aoe.imake.pst.hibernate.bean.PstJobPay missManual : ntcCalendars) {
			th.co.aoe.imake.pst.xstream.PstJobPay xmissManual =new th.co.aoe.imake.pst.xstream.PstJobPay ();
