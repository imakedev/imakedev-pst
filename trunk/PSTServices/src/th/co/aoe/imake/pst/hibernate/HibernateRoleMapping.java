	...
	public List listRoleMappingByrcId(Long rcId) throws DataAccessException {
		...
		Session session=sessionAnnotationFactory.getCurrentSession();
			...
			for (th.co.aoe.imake.pst.hibernate.bean.RoleMapping type : list) {
				th.co.aoe.imake.pst.xstream.RoleMapping xrole=new th.co.aoe.imake.pst.xstream.RoleMapping();
				th.co.aoe.imake.pst.hibernate.bean.RoleMappingPK pk= type.getId();
