...
public class PstConcreteResource extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.aoe.imake.pst.xstream.PstConcrete.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.aoe.imake.pst.xstream.PstConcrete xbpsTerm = new th.co.aoe.imake.pst.xstream.PstConcrete();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.aoe.imake.pst.xstream.PstConcrete) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						/*	String[] ids=xbpsTerm.getIds().split(",");
							...
							if (result != null && result.size() == 2) {
								...
								VResultMessage vresultMessage = new VResultMessage();
								List<th.co.aoe.imake.pst.xstream.PstConcrete> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.PstConcrete>();
	...
	private List<th.co.aoe.imake.pst.xstream.PstConcrete> getxPstConcreteObject(
			java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstConcrete> ntcCalendars) {
		List<th.co.aoe.imake.pst.xstream.PstConcrete> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.PstConcrete>(
				ntcCalendars.size());
		for (th.co.aoe.imake.pst.hibernate.bean.PstConcrete missManual : ntcCalendars) {
			th.co.aoe.imake.pst.xstream.PstConcrete xmissManual =new th.co.aoe.imake.pst.xstream.PstConcrete ();
