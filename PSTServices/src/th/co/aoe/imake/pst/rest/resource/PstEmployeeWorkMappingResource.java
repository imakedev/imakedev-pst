...
public class PstEmployeeWorkMappingResource  extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.aoe.imake.pst.xstream.PstEmployeeWorkMapping.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.aoe.imake.pst.xstream.PstEmployeeWorkMapping xbpsTerm = new th.co.aoe.imake.pst.xstream.PstEmployeeWorkMapping();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.aoe.imake.pst.xstream.PstEmployeeWorkMapping) ntcCalendarObj;
				if (xbpsTerm != null) { 
	...
	private Representation returnUpdateRecord(Representation entity,th.co.aoe.imake.pst.xstream.PstEmployeeWorkMapping xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.aoe.imake.pst.xstream.PstEmployeeWorkMapping> xbpsTerms = new ArrayList<th.co.aoe.imake.pst.xstream.PstEmployeeWorkMapping>(1);
