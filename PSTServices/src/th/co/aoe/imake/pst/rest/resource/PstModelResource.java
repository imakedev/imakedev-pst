...
import th.co.aoe.imake.pst.managers.PstModelService;
...
public class PstModelResource  extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.aoe.imake.pst.xstream.PstModel.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.aoe.imake.pst.xstream.PstModel xbpsTerm = new th.co.aoe.imake.pst.xstream.PstModel();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.aoe.imake.pst.xstream.PstModel) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						th.co.aoe.imake.pst.hibernate.bean.PstModel bpsTerm = new th.co.aoe.imake.pst.hibernate.bean.PstModel();
						...
						if(serviceName.equals(ServiceConstant.PST_MODEL_FIND_BY_ID)){
							...
							if(obj!=null){
								th.co.aoe.imake.pst.hibernate.bean.PstModel pstModel = (th.co.aoe.imake.pst.hibernate.bean.PstModel)obj;
								BeanUtils.copyProperties(pstModel, xbpsTerm) ;
							}
						//logger.debug(" object return ="+ntcCalendarReturn);
						VResultMessage vresultMessage = new VResultMessage();
							if(xbpsTerm!=null){
								List<th.co.aoe.imake.pst.xstream.PstModel> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.PstModel>(1);
							...
							for (int i = 0; i <ids.length; i++) {
								th.co.aoe.imake.pst.hibernate.bean.PstModel item = new th.co.aoe.imake.pst.hibernate.bean.PstModel();
							...
							if (result != null && result.size() == 2) {
								...
								java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstModel> ntcCalendars = (java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstModel>) result
										.get(0);
								String faqs_size = (String) result.get(1);
								VResultMessage vresultMessage = new VResultMessage();
								List<th.co.aoe.imake.pst.xstream.PstModel> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.PstModel>();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.aoe.imake.pst.xstream.PstModel xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.aoe.imake.pst.xstream.PstModel> xbpsTerms = new ArrayList<th.co.aoe.imake.pst.xstream.PstModel>(1);
	...
	private List<th.co.aoe.imake.pst.xstream.PstModel> getxPstModelObject(
			java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstModel> ntcCalendars) {
		List<th.co.aoe.imake.pst.xstream.PstModel> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.PstModel>(
				ntcCalendars.size());
		for (th.co.aoe.imake.pst.hibernate.bean.PstModel missManual : ntcCalendars) {
			th.co.aoe.imake.pst.xstream.PstModel xmissManual =new th.co.aoe.imake.pst.xstream.PstModel ();
	...
	protected Representation get(Variant variant) throws ResourceException {
		...
		th.co.aoe.imake.pst.xstream.PstModel  xbpsTerm =new th.co.aoe.imake.pst.xstream.PstModel();
		th.co.aoe.imake.pst.hibernate.bean.PstModel pstModel =new  th.co.aoe.imake.pst.hibernate.bean.PstModel();
		xbpsTerm.setPmId(1l);
		Object obj= pstCommonService.findById(pstModel.getClass(), xbpsTerm.getPmId());
		if(obj!=null){
			 pstModel = (th.co.aoe.imake.pst.hibernate.bean.PstModel)obj;
			BeanUtils.copyProperties(pstModel, xbpsTerm) ;
		}
	//logger.debug(" object return ="+ntcCalendarReturn);
	VResultMessage vresultMessage = new VResultMessage();
