...
import th.co.aoe.imake.pst.managers.PstCostService;
...
public class PstCostResource  extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.aoe.imake.pst.xstream.PstCost.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.aoe.imake.pst.xstream.PstCost xbpsTerm = new th.co.aoe.imake.pst.xstream.PstCost();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.aoe.imake.pst.xstream.PstCost) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						th.co.aoe.imake.pst.hibernate.bean.PstCost bpsTerm = new th.co.aoe.imake.pst.hibernate.bean.PstCost();
						...
						if(serviceName.equals(ServiceConstant.PST_COST_FIND_BY_ID)){
							...
							if(obj!=null){
								th.co.aoe.imake.pst.hibernate.bean.PstCost pstCost = (th.co.aoe.imake.pst.hibernate.bean.PstCost)obj;
								BeanUtils.copyProperties(pstCost, xbpsTerm) ;
							}
						//logger.debug(" object return ="+ntcCalendarReturn);
						VResultMessage vresultMessage = new VResultMessage();
							if(xbpsTerm!=null){
								List<th.co.aoe.imake.pst.xstream.PstCost> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.PstCost>(1);
							...
							for (int i = 0; i <ids.length; i++) {
								th.co.aoe.imake.pst.hibernate.bean.PstCost item = new th.co.aoe.imake.pst.hibernate.bean.PstCost();
							...
							if (result != null && result.size() == 2) {
								java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstCost> ntcCalendars = (java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstCost>) result
										.get(0);
								String faqs_size = (String) result.get(1);
								VResultMessage vresultMessage = new VResultMessage();
								List<th.co.aoe.imake.pst.xstream.PstCost> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.PstCost>();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.aoe.imake.pst.xstream.PstCost xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.aoe.imake.pst.xstream.PstCost> xbpsTerms = new ArrayList<th.co.aoe.imake.pst.xstream.PstCost>(1);
	...
	private List<th.co.aoe.imake.pst.xstream.PstCost> getxPstCostObject(
			java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstCost> ntcCalendars) {
		List<th.co.aoe.imake.pst.xstream.PstCost> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.PstCost>(
				ntcCalendars.size());
		for (th.co.aoe.imake.pst.hibernate.bean.PstCost missManual : ntcCalendars) {
			th.co.aoe.imake.pst.xstream.PstCost xmissManual =new th.co.aoe.imake.pst.xstream.PstCost ();
	...
	protected Representation get(Variant variant) throws ResourceException {
		...
		if(obj!=null){
			 pstCost = (th.co.aoe.imake.pst.hibernate.bean.PstCost)obj;
			BeanUtils.copyProperties(pstCost, xbpsTerm) ;
		}
	//logger.debug(" object return ="+ntcCalendarReturn);
	VResultMessage vresultMessage = new VResultMessage();
