...
import th.co.aoe.imake.pst.managers.PstCustomerService;
...
public class PstCustomerResource extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.aoe.imake.pst.xstream.PstCustomer.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.aoe.imake.pst.xstream.PstCustomer xbpsTerm = new th.co.aoe.imake.pst.xstream.PstCustomer();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.aoe.imake.pst.xstream.PstCustomer) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						th.co.aoe.imake.pst.hibernate.bean.PstCustomer bpsTerm = new th.co.aoe.imake.pst.hibernate.bean.PstCustomer();
						...
						if(serviceName.equals(ServiceConstant.PST_CUSTOMER_FIND_BY_ID)){
							...
							if(obj!=null){
								th.co.aoe.imake.pst.hibernate.bean.PstCustomer pstCustomer = (th.co.aoe.imake.pst.hibernate.bean.PstCustomer)obj;
								BeanUtils.copyProperties(pstCustomer, xbpsTerm) ;
							}
						//logger.debug(" object return ="+ntcCalendarReturn);
						VResultMessage vresultMessage = new VResultMessage();
							if(xbpsTerm!=null){
								List<th.co.aoe.imake.pst.xstream.PstCustomer> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.PstCustomer>(1);
							...
							for (int i = 0; i <ids.length; i++) {
								th.co.aoe.imake.pst.hibernate.bean.PstCustomer item = new th.co.aoe.imake.pst.hibernate.bean.PstCustomer();
							...
							if (result != null && result.size() == 2) {
								...
								java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstCustomer> ntcCalendars = (java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstCustomer>) result
										.get(0);
								String faqs_size = (String) result.get(1);
								VResultMessage vresultMessage = new VResultMessage();
								List<th.co.aoe.imake.pst.xstream.PstCustomer> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.PstCustomer>();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.aoe.imake.pst.xstream.PstCustomer xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.aoe.imake.pst.xstream.PstCustomer> xbpsTerms = new ArrayList<th.co.aoe.imake.pst.xstream.PstCustomer>(1);
	...
	private List<th.co.aoe.imake.pst.xstream.PstCustomer> getxPstCustomerObject(
			java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstCustomer> ntcCalendars) {
		List<th.co.aoe.imake.pst.xstream.PstCustomer> xntcCalendars = new ArrayList<th.co.aoe.imake.pst.xstream.PstCustomer>(
				ntcCalendars.size());
		for (th.co.aoe.imake.pst.hibernate.bean.PstCustomer missManual : ntcCalendars) {
			th.co.aoe.imake.pst.xstream.PstCustomer xmissManual =new th.co.aoe.imake.pst.xstream.PstCustomer ();
