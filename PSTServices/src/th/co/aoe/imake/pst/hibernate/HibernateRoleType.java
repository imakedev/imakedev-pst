...
/*	
	...
	public List listRoleTypeByRcId(Long rcId) throws DataAccessException {
		// TODO Auto-generated method stub
		//RoleType roleType = null;
		List<th.co.aoe.imake.pst.xstream.RoleType> roles=new ArrayList<th.co.aoe.imake.pst.xstream.RoleType>();
		Session session=sessionAnnotationFactory.getCurrentSession();
	//	Query query=session.createQuery(" select roleType from RoleType roleType where roleType.mmId=:mmId");
		...
		if(map.size()>0){
			for (Iterator iterator = map.keySet().iterator(); iterator.hasNext();) {
				...
				Object obj=query.uniqueResult();
				if(obj!=null){
					th.co.aoe.imake.pst.hibernate.bean.RoleType  type=(th.co.aoe.imake.pst.hibernate.bean.RoleType)obj;
					th.co.aoe.imake.pst.xstream.RoleType  xtype=new th.co.aoe.imake.pst.xstream.RoleType();
	...
	public List listRoleTypes(Long maId) throws DataAccessException {
		...
		if(maId!=null && maId.intValue()!=0){
		 ...
		 logger.debug("exclude="+exclude);
			...
			List<th.co.aoe.imake.pst.hibernate.bean.RoleType> list=query.list();
			List<th.co.aoe.imake.pst.xstream.RoleType> roles=new ArrayList<th.co.aoe.imake.pst.xstream.RoleType>(list.size());
			for (th.co.aoe.imake.pst.hibernate.bean.RoleType type : list) {
				th.co.aoe.imake.pst.xstream.RoleType xrole=new th.co.aoe.imake.pst.xstream.RoleType();
